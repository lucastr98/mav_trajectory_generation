...
for i in range(0, number_of_traj, 1):
    axes[0][0].plot(trajectory_time_list[i], trajectory_pos_x_list[i], '.', label='command', c='r')
    axes[1][0].plot(trajectory_time_list[i], trajectory_pos_y_list[i], '.', label='command', c='r')
    axes[2][0].plot(trajectory_time_list[i], trajectory_pos_z_list[i], '.', label='command', c='r')
    axes[0][1].plot(trajectory_time_list[i], trajectory_lin_vel_x_list[i], '.', label='command', c='r')
    axes[1][1].plot(trajectory_time_list[i], trajectory_lin_vel_y_list[i], '.', label='command', c='r')
    axes[2][1].plot(trajectory_time_list[i], trajectory_lin_vel_z_list[i], '.', label='command', c='r')
